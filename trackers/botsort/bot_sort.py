...
class BoTSORT(object):
    ...
    def update(self, output_results, img, img_path, encoder, pose):  # img_path, encoder, pose 추가
        self.frame_id += 1
        activated_starcks = []
        refind_stracks = []
        lost_stracks = []
        ...
        #     # strack.curr_feat = None
        #     # strack.smooth_feat = None
        #     # strack.features = []
        #     del strack.curr_feat
        #     del strack.smooth_feat
        #     # del strack.features
        #     del strack
        # self.removed_stracks.clear()
        # del activated_starcks
        # del refind_stracks
        # del removed_stracks
        # del lost_stracks
        # del unconfirmed
